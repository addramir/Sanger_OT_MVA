...
result1 <- GWAS_linear_combination_Z_basedC(a=a, Z=as.matrix(Zs), covm=as.matrix(phe), N=as.matrix(N1), eaf=eaf)
...
fwrite(x=res,file="~/projects/MVA_output/02_PD_gwas/full_gwas/GIP1_5_traits_neff.txt",sep="\t")
